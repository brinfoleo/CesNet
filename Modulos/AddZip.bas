...
'Compacta um ou mais arquivos no formato WinZip
    ...
    Z = addZIP_SaveStructure(azSTRUCTURE_RELATIVE) '(SalvaDir) 'StoreFullPathName - azSTRUCTURE_ABSOLUTE
...
Exit Sub
InializaZipError:
    MsgBox "Erro inicializando bibliotecas ZIP", vbInformation, "CESNet - Aviso"
End Sub
