VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptListMatricula 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "CESNet - Listagem de Matrículas"
   ClientHeight    =   8805
   ClientLeft      =   1635
   ClientTop       =   1530
   ClientWidth     =   12840
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Listagem de Matrículas"
         Alignment       =   1
      EndProperty
   EndProperty
   SectionCode1    =   4
   ...
   EndProperty
End
Attribute VB_Name = "rptListMatricula"
...
Private Sub DataReport_Initialize()
    rptListMatricula.Sections("Cab").Controls.Item("lbNomeCES").Caption = UnidadeEnsinoNome
End Sub
