...
Begin VB.Form frmMain 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   306
   Begin VB.Menu Capturar 
      Caption         =   "Capturar"
   End
   Begin VB.Menu SalvarSair 
...
Private Sub Form_Load()
    ...
    If False = retVal Then
        ...
        MsgBox "Câmera não encontrada! Favor verifique a conexão!", vbCritical, "CESNet - Aviso"
        Unload Me
...
'retVal = VBGetSaveFileName(FileName, _
                            ...
                            Owner:=Me.hWnd)
'If False <> retVal Then
    NumeroFicha = Format(NumeroFicha, "000000000")
    FileName = PathBD & "\Database\Img\" & NumeroFicha & "001.jpg"
    retVal = capFileSaveDIB(hCapWnd, FileName)
    If True <> retVal Then
        MsgBox "Erro salvando Imagem." ', vbInformation, App.Title
    End If
'End If
Unload Me
End Sub
Public Sub InicializarCaptura(NumFicha As String)
    On Error GoTo TrtErro
    NumeroFicha = NumFicha
    Me.Caption = "CESNet - Captura [" & NumFicha & "]"
    Me.Show 1
    Exit Sub
TrtErro:
