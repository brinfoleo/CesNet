...
Begin VB.Form Form_RelatAlunos 
   ...
   ClientTop       =   330
   ClientWidth     =   6030
   Icon            =   "Form_RelatAlunos.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton Bt_Imprimir 
      ...
      Height          =   795
      Left            =   3660
      Picture         =   "Form_RelatAlunos.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   660
      Width           =   2205
   ...
   Begin VB.Label Label8 
      Alignment       =   2  'Center
      BackColor       =   &H00C00000&
      Caption         =   "RELATÓRIO DE ALUNOS MATRICULADOS"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "Form_RelatAlunos"
...
Private Sub Bt_Imprimir_Click()
    ...
    Criterio = "SELECT Matriculas.*, MatriculaEnsino.DtInicio, MatriculaEnsino.EnsinoID, Ensino.* " & _
                ...
                "Where (((MatriculaEnsino.DtInicio) >= #" & Format(DTP_Ini.Value, "mm/dd/yyyy") & "# And (MatriculaEnsino.DtInicio) <= #" & Format(DTP_Final.Value, "mm/dd/yyyy") & "#)) " & _
                "ORDER BY MatriculaEnsino.EnsinoID,MatriculaEnsino.MatrID"
    ...
    Call Relatorio(rptListMatricula, Criterio)
    rptListMatricula.Show 1
